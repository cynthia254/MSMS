<template>
  ...
  <button class="button">
    ...
    <span @click="showModal = true">Add new store</span>
  </button>
</div>
  ...
  >
    ...
    >
      ...
      <tbody v-for="(product, index) in data_formBody" v-bind:key="product.storeId">
    <tr>
          <td>{{index + 1}}</td>
      ...
      <div class="popup-dialog">
        <div class="popup-content" style="max-height: 90vh; overflow-y: auto;">
          <div class="popup-header" style="display: flex; justify-content: space-between;">
             <h4 class="popup-title">Add Store</h4>
            <button @click="showModal = false" type="btn" class="popup-title">&times;</button>
          </div>
<div class="popup-body">
  <form>
    <div class="form-group d-flex">
  <label for="stoeName" class="mr-2" style="width: 120px;">Store Name:</label>
  <input
    type="text"
    class="form-control"
    id="storeName"
...
<div class="form-group d-flex">
  <label for="Phone Number" class="mr-2" style="width: 120px;">Phone Number:</label>
  <input
    type="text"
    class="form-control"
    id="phoneNumber"
...
<div class="form-group d-flex">
  <label for="website" class="mr-2" style="width: 120px;">Company's Website:</label>
  <input
    type="text"
    class="form-control"
    id="website"
...
<div class="form-group d-flex">
  <label for="location" class="mr-2" style="width: 120px;">Location:</label>
  <input
    type="text"
    class="form-control"
    id="location"
...
logImageData(product) {
 ...
 var response = await this.addingStores(body);
...
async gettingLoggedInUser(){
  ...
  created(){
    ...
    this.gettingProductByMerchantId();
